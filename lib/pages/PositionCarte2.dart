...
class PositionCarte2 extends StatefulWidget {
  // MyStatefulWidget({Key key}) : super(key: key);

  @override
  _PositionCarte2State createState() => _PositionCarte2State();
}

class _PositionCarte2State extends State<PositionCarte2> {
  int _cIndex = 2;
